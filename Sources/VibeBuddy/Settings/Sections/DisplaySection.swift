...
/// What the pill and the panel put on screen. Both are gone: they are fixed at the
/// values the faces are drawn for — grain 3 (`BuddyView.pixelSize`), size 100 % of the
/// manifest (`PillLayout.resolve`) — and every other setting they could take made the
/// buddy read worse.
